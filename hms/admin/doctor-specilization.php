...
if(isset($_POST['submit'])){
	$sql="insert into doctorSpecilization(specilization) values('".$_POST['doctorspecilization']."')";
...
if(isset($_GET['del'])){
  	$delq = "DELETE FROM `doctorspecilization` WHERE id= '".$_GET['id']."' ";
		...
		<div class="main-content" >
			<div class="wrap-content container" id="container">
				...
				<section id="page-title">
					<div class="row">
						<div class="col-sm-8">
							<h1 class="mainTitle">Admin | Add Doctor Specialization</h1></div>
						<ol class="breadcrumb">
							<li>
								<span>Admin</span>
							</li>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<table class="table table-hover" id="sample-table-1">
								...
								<tbody>
								<?php
									$qry="SELECT * FROM `doctorspecilization` ";
									$st = $conn->prepare($qry);
									$st->execute();
									$cnt=1;
								...
								?>
									...
									<tr>
										...
										<td class="hidden-xs"><?= $row['specilization'];?></td>
