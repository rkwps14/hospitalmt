...
{	
	$sql="UPDATE `doctorspecilization` SET `specilization`='".$_POST['doctorspecilization']."',`updationDate`='".$currentTime."' WHERE id='".$id."' ";
	$stpre = $conn->prepare($sql);
	$stpre->execute();
															...
															<label for="exampleInputEmail1">
																...
																<?php 
																	$id=$_GET['id'];
																		...
																		$qry="SELECT * FROM `doctorspecilization` WHERE id='".$id."' ";
