...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE `users` SET `fullName`='$fname',`address`='$address',`city`='$city',`gender`='$gender' WHERE id= '". $_SESSION['id']."' ";
												...
												<div class="panel-body">
													...
													<form role="form" name="edit" method="post">
														<div class="form-group">
															...
															<input type="text" name="fname" class="form-control" value="<?= $data['fullName']; ?>" >
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<input type="text" name="gender" class="form-control" required="required" value="<?= $data['gender']; ?>">
														</div>
														<div class="form-group">
															<label for="fess">User Email</label>
															<input type="email" name="uemail" class="form-control"  readonly="readonly" value="<?= $data['email']; ?>">
														</div>
														<?php } ?>
